...
EXEC pInsAppointments
    @AppointmentDateTime = '07/04/2019 8:30:14',  
    @AppointmentClinicID = '2', 
    @AppointmentDoctorID = '3', 
    @AppointmentPatientID = '9';

EXEC pInsAppointments
    @AppointmentDateTime = '10/04/2019 11:52:28',  
    @AppointmentClinicID = '1', 
    @AppointmentDoctorID = '7', 
    @AppointmentPatientID = '7';

EXEC pInsAppointments
    @AppointmentDateTime = '08/06/2019 8:20:05',  
    @AppointmentPatientID = '5', 
    @AppointmentDoctorID = '7', 
    @AppointmentClinicID = '2';

EXEC pInsAppointments
    @AppointmentDateTime = '04/12/2019 6:48:03',  
    @AppointmentPatientID = '4', 
    @AppointmentDoctorID = '4', 
    @AppointmentClinicID = '3';

EXEC pInsAppointments
    @AppointmentDateTime = '01/13/2020 16:07:48',  
    @AppointmentPatientID = '1', 
    @AppointmentDoctorID = '6', 
    @AppointmentClinicID = '1';

EXEC pInsAppointments
    @AppointmentDateTime = '04/02/2019 8:50:35',  
    @AppointmentPatientID = '5', 
    @AppointmentDoctorID = '8', 
    @AppointmentClinicID = '3';

EXEC pInsAppointments
    @AppointmentDateTime = '10/14/2019 16:18:16',  
    @AppointmentPatientID = '1', 
    @AppointmentDoctorID = '10', 
    @AppointmentClinicID = '1';

EXEC pInsAppointments
    @AppointmentDateTime = '01/05/2020 4:16:59',  
    @AppointmentPatientID = '1', 
    @AppointmentDoctorID = '7', 
    @AppointmentClinicID = '2';

EXEC pInsAppointments
    @AppointmentDateTime = '10/12/2019 0:22:52',  
    @AppointmentPatientID = '1', 
    @AppointmentDoctorID = '9', 
    @AppointmentClinicID = '4';

EXEC pInsAppointments
    @AppointmentDateTime = '05/01/2019 10:45:15',  
    @AppointmentPatientID = '4', 
    @AppointmentDoctorID = '6', 
